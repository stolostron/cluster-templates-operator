...
func getEditHelmChartTask() console.ConsoleQuickStartTask {
	...
	description += "3. Edit the chart you want to use. For example, edit the files in the hyphershift-template folder\n"
...
3. In the installation step, click on the **Helm chart repository** dropdown, and then click on **Add another repository URL**.`
	...
	description += `5. Select the chart you edited, for example hypershift-template and click **Next**.
...
Use this quick start for creating your own cluster template based on a community template. You’ll be able to create the helm charts for the day1 cluster and configure the day2 ArgoCD applications.`,
