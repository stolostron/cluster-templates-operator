...
//+kubebuilder:rbac:groups=clustertemplate.rawagner.com,resources=clustertemplates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=clustertemplate.rawagner.com,resources=clustertemplates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=clustertemplate.rawagner.com,resources=clustertemplates/finalizers,verbs=update
