...
import (
	...
	"github.com/stolostron/cluster-templates-operator/generated/clientset/versioned/scheme"
...
func (c *V1alpha1Client) ClusterTemplates(namespace string) ClusterTemplateInterface {
	return newClusterTemplates(c, namespace)
}

func (c *V1alpha1Client) ClusterTemplateInstances(namespace string) ClusterTemplateInstanceInterface {
