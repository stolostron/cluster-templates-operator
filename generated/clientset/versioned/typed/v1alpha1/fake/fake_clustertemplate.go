...
var clustertemplatesResource = schema.GroupVersionResource{Group: "", Version: "v1alpha1", Resource: "clustertemplates"}

var clustertemplatesKind = schema.GroupVersionKind{Group: "", Version: "v1alpha1", Kind: "ClusterTemplate"}
...
func (c *FakeClusterTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(clustertemplatesResource, c.ns, name, opts), &v1alpha1.ClusterTemplate{})
